...
public class SelesaiLemburActivity extends AppCompatActivity {

    @BindView(R.id.tv_jam)
    TextView tvJam;
    @BindView(R.id.tv_menit)
    TextView tvMenit;
    @BindView(R.id.btn_scan_selesai_lembur)
    Button btnScanSelesaiLembur;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_selesai_lembur);
    ...
    private void initUi(){
        ...
        btnScanSelesaiLembur.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new Scan(SelesaiLemburActivity.this, "4");
            }
        });
    }
