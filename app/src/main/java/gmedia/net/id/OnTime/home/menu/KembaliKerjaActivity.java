...
public class KembaliKerjaActivity extends AppCompatActivity {

    @BindView(R.id.tv_jam)TextView tvJam;
    @BindView(R.id.tv_menit)TextView tvMenit;
    @BindView(R.id.btn_scan_kembali_kerja)Button btnScanKembaliKerja;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kembali_kerja);
    ...
    private void initUi(){
        ...
        btnScanKembaliKerja.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new Scan(KembaliKerjaActivity.this, "4");
            }
        });
    }
