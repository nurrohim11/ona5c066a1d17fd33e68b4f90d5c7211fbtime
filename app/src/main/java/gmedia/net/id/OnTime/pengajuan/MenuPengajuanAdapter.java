...
public class MenuPengajuanAdapter extends RecyclerView.Adapter<MenuPengajuanAdapter.ViewHolder>{

    private Context mContext;
    private List<CustomModel> customModels;

    public MenuPengajuanAdapter(Context context, List<CustomModel> customModels){
