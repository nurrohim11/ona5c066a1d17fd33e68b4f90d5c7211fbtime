...
public class RekapAbsensiActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        rlTglAwal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new DatePickerDialog(RekapAbsensiActivity.this, date, customDate.get(java.util.Calendar.YEAR), customDate.get(java.util.Calendar.MONTH), customDate.get(java.util.Calendar.DATE)).show();
            }
        });
    ...
    private void showSheetAbsensi(){
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(RekapAbsensiActivity.this);
        ...
        new ApiVolley(RekapAbsensiActivity.this,jbody,"POST", ServerUrl.viewAbsensi,
                new AppRequestCallback(new AppRequestCallback.ResponseListener() {
                    ...
                    public void onSuccess(String response, String message) {
                        try {
                            ...
                            adapter = new AbsensiAdapter(RekapAbsensiActivity.this,absensiModels);
                    ...
                    public void onEmpty(String message) {
                        Toasty.error(RekapAbsensiActivity.this,message, Toast.LENGTH_SHORT).show();
                        rvAbsensi.setAdapter(null);
                    }

                    @Override
                    public void onFail(String message) {
                        Toasty.error(RekapAbsensiActivity.this,"Terjadi kesalahan saat memuat data",Toast.LENGTH_SHORT).show();
                        rvAbsensi.setAdapter(null);
                    }
                })
        );
