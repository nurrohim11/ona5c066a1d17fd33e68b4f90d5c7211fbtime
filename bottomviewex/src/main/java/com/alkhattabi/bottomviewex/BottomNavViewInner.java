...
public class BottomNavViewInner extends BottomNavigationView {
    // used for animation
    ...
    public BottomNavViewInner(Context context) {
        this(context, null);
    }

    public BottomNavViewInner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BottomNavViewInner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mMenuView.updateMenuView();
     ...
     * @param viewPager
     */
    public BottomNavViewInner setupWithViewPager(final ViewPager viewPager) {
     ...
     */
    public BottomNavViewInner setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link BottomNavViewInner} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<BottomNavViewInner> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(BottomNavViewInner bnve) {
        ...
        public void onPageSelected(final int position) {
            final BottomNavViewInner bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, BottomNavViewInner bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
