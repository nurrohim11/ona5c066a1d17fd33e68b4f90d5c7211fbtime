...
public class SweetBottomNavbarInner extends BottomNavigationView {
    // used for animation
    ...
    public SweetBottomNavbarInner(Context context) {
        this(context, null);
    }

    public SweetBottomNavbarInner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SweetBottomNavbarInner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mMenuView.updateMenuView();
     ...
     * @param viewPager
     */
    public SweetBottomNavbarInner setupWithViewPager(final ViewPager viewPager) {
     ...
     */
    public SweetBottomNavbarInner setupWithViewPager(final ViewPager viewPager, boolean smoothScroll) {
        if (mViewPager != null) {
     ...
     * necessary calls back to the provided {@link SweetBottomNavbarInner} so that the tab position is
     * kept in sync.
     * <p>
    ...
    private static class BottomNavigationViewExOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<SweetBottomNavbarInner> mBnveRef;

        public BottomNavigationViewExOnPageChangeListener(SweetBottomNavbarInner bnve) {
        ...
        public void onPageSelected(final int position) {
            final SweetBottomNavbarInner bnve = mBnveRef.get();
...
//            Log.d("onPageSelected", "--------- position " + position + " ------------");
    ...
    private static class MyOnNavigationItemSelectedListener implements OnNavigationItemSelectedListener {
        ...
        MyOnNavigationItemSelectedListener(ViewPager viewPager, SweetBottomNavbarInner bnve, boolean smoothScroll, OnNavigationItemSelectedListener listener) {
